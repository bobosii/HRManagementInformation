...
import com.HRManagementInformation.dto.request.LeaveTypeSaveRequest;
import com.HRManagementInformation.dto.request.LeaveTypeUpdateRequest;
...
public class LeaveTypeController {
    ...
    public ResultData<LeaveTypeResponse> update(@PathVariable("id") int id, @RequestBody LeaveTypeUpdateRequest request) {
        ...
        return ResultHelper.success(modelMapperService.forResponse().map(existing, LeaveTypeResponse.class));
    }
